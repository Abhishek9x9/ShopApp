package com.example.abhishekshukla.shopapp.activity.scanner;
...
//            r.play();
//
//            ringProgressDialog = ProgressDialog.show(mScannerView.getContext(), "Please wait", "Try to fetch the product information...", true);
//            ringProgressDialog.setCancelable(true);
//        } catch (Exception e) {
//        }
//        showMessageDialog("#ScannerFragment Contents = " + rawResult.getText() + ", Format = " + rawResult.getBarcodeFormat().toString());
