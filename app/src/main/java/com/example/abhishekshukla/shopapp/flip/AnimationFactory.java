package com.example.abhishekshukla.shopapp.flip;

/**
 * Created by nishantgupta on 7/9/15.
 */
...
public class AnimationFactory {
     ...
     */
    public static void flipTransition(final View fromView, final View toView, final ViewAnimator viewAnimator, FlipDirection dir) {
